...
const firebaseApp = firebase.initializeApp({
  // code directly from firebase, we grab 3 servers from firebase (db database) (auth for log in log out creat users etc) and (storage, how we upload a bunch of pictures etc..) );
